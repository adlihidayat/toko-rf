      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="flex justify-center mb-6 relative">
            <div className="h-36 bg-gradient-to-b from-[#00BCA8]/10 to-[#00BCA8] w-px absolute bottom-0 z-0"></div>
            <span className="px-3.5 py-1.5 bg-gradient-to-r to-[#00E19D] from-[#009AB2] rounded-full text-background z-10 font-bold">
              3
            </span>
          </div>
          <div className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {packages.map((pkg, index) => (
            <PackageCard
              ...
              rating={pkg.rating}
              reviews={pkg.reviews}
              onBuy={() => console.log(`Bought ${pkg.name}`)}
            />
          ))}
        </div>
